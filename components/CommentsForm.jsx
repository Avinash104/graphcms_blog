...
//           <textarea 
//           ref={commentEl} 
//           className='p-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-700' 
//           placeholder='comment'
//           name='comment'
//           />
//         </div>
...
//           className='py-4 px-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-700' 
//           placeholder='name'
//           name='name'
//           />
//           <input 
...
//           className='transition duration-500 ease hover:bg-indigo-900 bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer inline-block'
//           >
//             Post Comment
//           </button>
